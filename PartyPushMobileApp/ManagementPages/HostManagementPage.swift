...
//
//func AddStudent(completion: @escaping ((String) -> Void))
//{
...
//}
//
//func GetStudentList(completion: @escaping ((String) -> Void))
//{
//    guard let url = URL(string: "https://m5pw23ec4k.execute-api.us-east-1.amazonaws.com/hello")
//    else
//    {
...
//        Button {
//            Task {
//                let block: (String) -> Void = { id in
//                    studentToAdd = id
//                }
//                AddStudent(completion: block)
//            }
//        } label: {
//            Text("Add student")
//        }
//        Button {
//            Task {
//                let block: (String) -> Void = { name in
//                    studentList = name
//                }
//                GetStudentList(completion: block)
//            }
//        } label: {
